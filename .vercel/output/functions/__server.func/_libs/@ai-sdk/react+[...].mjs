...
import { A as getRuntimeEnvironmentUserAgent, At as UnsupportedFunctionalityError, B as isUrlSupported, Ct as union, D as fetchWithValidatedRedirects, Dt as InvalidPromptError, E as executeTool, Et as APICallError, H as normalizeHeaders, I as isExecutableTool, J as resolve, L as isFullMediaType, N as isAbortError, O as filterNullable, P as isBuffer, Q as safeValidateTypes, R as isNonNullable, St as string, Tt as AISDKError, U as parseJsonEventStream, V as lazySchema, X as retryWithExponentialBackoff, Z as safeParseJSON, _ as convertUint8ArrayToBase64, _t as looseObject, bt as object$1, c as DownloadError, ct as _instanceof, d as asSchema, dt as array$1, f as cancelResponseBody, ft as boolean, gt as literal, ht as lazy, it as zodSchema, j as getToolCaller, jt as getErrorMessage, k as generateId, kt as TypeValidationError, lt as _null, m as convertBase64ToUint8Array, mt as discriminatedUnion, n as GatewayError, nt as withUserAgentSuffix, o as DEFAULT_MAX_DOWNLOAD_SIZE, pt as custom, q as readResponseWithSizeLimit, r as gateway, s as DelayedPromise, st as _enum, t as GatewayAuthenticationError, tt as validateTypes, u as asArray, vt as never, w as detectMediaType, wt as unknown, xt as record, y as createIdGenerator, yt as number, z as isProviderReference } from "./gateway+[...].mjs";
...
function useChat({ throttle: throttle2, experimental_throttle, resume = false, ...options } = {}) {
	...
	const subscribeToMessages = (0, import_react.useCallback)((update) => chatRef.current["~registerMessagesCallback"](update, throttleWaitMs), [throttleWaitMs, chatRef.current.id]);
	const messages = (0, import_react.useSyncExternalStore)(subscribeToMessages, () => chatRef.current.messages, () => chatRef.current.messages);
...
//#endregion
export { streamText as a, isStepCount as i, DefaultChatTransport as n, require_jsx_runtime as o, convertToModelMessages as r, require_react as s, useChat as t };
