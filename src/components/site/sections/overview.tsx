      ...
      <div className="mx-auto grid w-[min(1200px,92vw)] gap-14 lg:grid-cols-[0.95fr_1.05fr]">
        <div>
          ...
          <Reveal delay={0.16} className="mt-10 grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={i.t} className="rounded-none border border-hairline bg-surface/60 p-5">
        ...
        <Reveal delay={0.12} className="relative">
          <div className="sticky top-28 rounded-none border border-hairline bg-card p-7 shadow-[var(--shadow-soft)]">
            ...
            <div className="mt-8 rounded-none border border-hairline bg-surface/60 p-4">
            ...
            return (
              <StaggerItem key={m.name} className={i === 0 ? "lg:col-span-2" : undefined}>
                <TiltCard className="h-full">
                  <article className="surface-card group flex h-full flex-col rounded-none p-7">
                    <div className="flex items-start justify-between gap-4">
                      <span className="grid h-12 w-12 shrink-0 place-items-center rounded-none bg-emerald-soft text-accent-foreground transition-transform duration-500 group-hover:scale-110">
